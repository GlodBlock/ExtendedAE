...
public class ItemEMCInterfaceUpgrade extends ItemUpgrade {
    ...
    public ItemEMCInterfaceUpgrade() {
        ...
        this.addTile(EMCInterfaceBlockEntity.class, APESingletons.EX_EMC_INTERFACE, TileExEMCInterface.class);
        this.addPart(EMCInterfacePart.class, APESingletons.EX_EMC_INTERFACE_PART);
    }
