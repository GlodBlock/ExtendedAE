...
These upgrades allow you to replace normal ME devices with their extended versions without breaking them.
...
Sneak-right-click these devices with the corresponding upgrades to turn them into their extended versions. All device settings and inventory
...
<GameScene zoom="6" background="transparent">
  ...
  <BoxAnnotation color="#ffffff" min="1 0 0" max="4 1 1">
        Normal Pattern Providers. You can upgrade them with a Pattern Provider Upgrade.
...
<GameScene zoom="6" background="transparent">
  ...
  <BoxAnnotation color="#ffffff" min="1 0 0" max="4 1 1">
        The Extended Pattern Providers retain all settings and pattern inventory from the original Pattern Providers.
  </BoxAnnotation>
</GameScene>
