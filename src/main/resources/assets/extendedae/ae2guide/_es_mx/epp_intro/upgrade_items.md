...
navigation:
    ...
    title: Mejora de dispositivos ME
...
# Mejora de dispositivos ME

Estas mejoras te permiten reemplazar dispositivos ME normales con su versión extendida sin romperlos.
...
<GameScene zoom="6" background="transparent">
  ...
  <BoxAnnotation color="#ffffff" min="1 0 0" max="4 1 1">
        Los proveedores de patrones normales. Puedes mejorarlos con la mejora de proveedor de patrones.
...
<GameScene zoom="6" background="transparent">
  ...
  <BoxAnnotation color="#ffffff" min="1 0 0" max="4 1 1">
        Los proveedores de patrones extendidos mantienen todos los ajustes e inventario de patrones de los proveedores de patrones originales.
  </BoxAnnotation>
</GameScene>

## Lista de mejoras

|                                    Mejora                                    |                         Dispositivo normal                         |                           Dispositivo extendido                            |
|:----------------------------------------------------------------------------:|:------------------------------------------------------------------:|:--------------------------------------------------------------------------:|
