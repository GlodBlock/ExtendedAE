...
The ME Extended Import/Export Bus works faster than the normal <ItemLink id="ae2:import_bus" />/<ItemLink id="ae2:export_bus" />
(the default speed multiplier is 8, and it is configurable).
