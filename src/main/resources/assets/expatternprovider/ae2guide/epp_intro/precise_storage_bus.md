...
The ME Precise Storage Bus is a <ItemLink id="ae2:storage_bus" /> that can be configured with an amount limit, and it will only insert items up to that limit.
