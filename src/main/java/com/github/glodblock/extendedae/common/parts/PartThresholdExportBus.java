...
public class PartThresholdExportBus extends ExportBusPart {
    ...
    public static List<ResourceLocation> MODELS = Arrays.asList(
            new ResourceLocation(EAE.MODID, "part/threshold_export_bus_base"),
    ...
    public ConfigInventory getConfig() {
        if (this.config == null) {
            this.config = ConfigInventory.configStacks(StackWorldBehaviors.hasExportStrategyFilter(), 63, () -> Ae2Reflect.updatePartState(this), true);
        }
        return this.config;
    }
