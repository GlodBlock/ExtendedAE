package com.github.glodblock.eterminal.common.parts;
...
public class PartExPatternAccessTerminal extends AbstractDisplayPart implements IConfigurableObject {
    ...
    public static List<ResourceLocation> MODELS = Arrays.asList(
            new ResourceLocation(EnhancedTerminal.MODID, "part/ex_pattern_access_terminal_off"),
            new ResourceLocation(EnhancedTerminal.MODID, "part/ex_pattern_access_terminal_on")
    );
