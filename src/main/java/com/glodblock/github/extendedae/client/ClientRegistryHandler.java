...
import com.glodblock.github.extendedae.client.render.tesr.VacuumInterfaceTESR;
...
public class ClientRegistryHandler {
    ...
    public void registerGui(RegisterMenuScreensEvent event) {
        ...
        InitScreens.register(event, ContainerVacuumInterface.TYPE, GuiVacuumInterface::new, "/screens/vacuum_interface.json");
    ...
    public void registerModels(ModelEvent.RegisterGeometryLoaders event) {
        ...
        BlockEntityRenderers.register(GlodUtil.getTileType(TileVacuumInterface.class), VacuumInterfaceTESR::new);
