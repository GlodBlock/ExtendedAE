...
public class ExPlaneModel implements IUnbakedGeometry<ExPlaneModel> {
    ...
    public ExPlaneModel(Identifier frontTexture, Identifier sidesTexture, Identifier backTexture) {
    ...
    public record Loader(Identifier frontTexture) implements IGeometryLoader<ExPlaneModel> {
