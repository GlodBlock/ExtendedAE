...
public class EPPIcon {
    ...
    private static final Identifier TEXTURE = ExtendedAE.id("textures/guis/nicons.png");
    ...
    public static final Blitter OUTPUT_SIDES = Blitter.texture(TEXTURE, 64, 64).src(0, 16, 16, 16);
