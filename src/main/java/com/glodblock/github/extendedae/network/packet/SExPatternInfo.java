...
public class SExPatternInfo implements IMessage {
    ...
    public SExPatternInfo(long id, BlockPos pos, ResourceKey<@NotNull Level> dim, @Nullable Direction face) {
        this.id = id;
        this.pos = pos;
        this.dim = dim;
        this.face = face;
    ...
    public SExPatternInfo(long id, BlockPos pos, ResourceKey<@NotNull Level> dim) {
