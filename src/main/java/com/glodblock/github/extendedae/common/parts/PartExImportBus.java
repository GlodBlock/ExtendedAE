...
public class PartExImportBus extends ImportBusPart {
    ...
    public static List<Identifier> MODELS = Arrays.asList(
            Identifier.fromNamespaceAndPath(ExtendedAE.MODID, "part/ex_import_bus_base"),
            Identifier.fromNamespaceAndPath(AppEngBase.MOD_ID, "part/import_bus_on"),
            Identifier.fromNamespaceAndPath(AppEngBase.MOD_ID, "part/import_bus_off"),
            Identifier.fromNamespaceAndPath(AppEngBase.MOD_ID, "part/import_bus_has_channel")
    );
