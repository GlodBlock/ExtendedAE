...
public class CircuitCutterCategory extends EAERecipeCategory<CircuitCutterRecipe> {
    ...
    public static RecipeType<RecipeHolder<CircuitCutterRecipe>> RECIPE_TYPE = RecipeType.createFromVanilla(CircuitCutterRecipe.TYPE);
    private final IDrawableAnimated progress;

    public CircuitCutterCategory(IGuiHelper helpers) {
        super(helpers, RECIPE_TYPE, EAESingletons.CIRCUIT_CUTTER, 94, 26);
