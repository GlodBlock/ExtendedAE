...
public abstract class EAERecipeCategory<R extends Recipe<RecipeInput>> extends AbstractRecipeCategory<RecipeHolder<R>> {

    protected IDrawable background;

    public EAERecipeCategory(IGuiHelper helpers, RecipeType<RecipeHolder<R>> recipeType, ItemLike icon, int width, int height) {
        this(helpers, recipeType, new ItemStack(icon), width, height);
    }

    public EAERecipeCategory(IGuiHelper helpers, RecipeType<RecipeHolder<R>> recipeType, ItemStack icon, int width, int height) {
        super(
                recipeType,
                icon.getHoverName(),
