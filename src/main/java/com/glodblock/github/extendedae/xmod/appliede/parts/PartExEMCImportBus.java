...
public class PartExEMCImportBus extends EMCImportBusPart {

    public static List<ResourceLocation> MODELS = Arrays.asList(
            new ResourceLocation(ExtendedAE.MODID, "part/ex_emc_import_bus_base"),
    ...
    public PartExEMCImportBus(IPartItem<?> partItem) {
        super(partItem);
    }
    ...
    protected MenuType<?> getMenuType() {
        return ContainerExEMCIOBus.IMPORT_TYPE;
    }
