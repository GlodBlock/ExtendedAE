...
public class ItemGTEUCell extends AEBaseItem implements IFluxCell {

    private final ItemLike coreItem;
    private final long totalBytes;
    private final double idleDrain;

    public ItemGTEUCell(ItemLike coreItem, int kilobytes, double idleDrain) {
    ...
    public void addCellInformationToTooltip(ItemStack is, List<Component> lines) {
        ...
        GTEUCellHandler.HANDLER.addCellInformationToTooltip(is, lines);
    }
        ...
        if (InteractionUtil.isInAlternateUseMode(player)) {
            ...
            if (inv != null && playerInventory.getSelected() == stack) {
                ...
                if (list.isEmpty()) {
                    ...
                    playerInventory.placeItemBackInInventory(new ItemStack(AFItemAndBlock.GTEU_HOUSING));
                    return true;
                }
            }
        }
