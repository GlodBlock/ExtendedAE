...
public class ItemFECell extends AEBaseItem implements IFluxCell {
    ...
    public ItemFECell(Properties properties, int kilobytes, double idleDrain) {
    ...
    private boolean disassembleDrive(ItemStack stack, Level level, Player player) {
        ...
        var disassembledStacks = StorageCellDisassemblyRecipe.getDisassemblyResult(serverLevel, stack.getItem());
    ...
    @Override
    @ParametersAreNonnullByDefault
    public void appendHoverText(ItemStack is, @Nullable Item.TooltipContext level, TooltipDisplay tooltipDisplay, Consumer<Component> lines, TooltipFlag tooltipFlag) {
    ...
    @Override
    public @Nullable EnergyHandler getCapability(@NotNull ItemStack stack, @Nullable ItemAccess context) {
